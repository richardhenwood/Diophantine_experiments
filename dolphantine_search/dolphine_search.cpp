...
void test_ab (long int coeff_a, long int coeff_b, long int h_height, long int l_height, multimap<char *, uv_long, cmp_str> &myMMap, int rank, char * logpath);
...
int process_range (
    ...
    multimap<char *, uv_long, cmp_str> myMMap;
    ...
    while (current_u <= h_height) {
        ...
        while (current_v <= h_height) {
            ...
            myMMap.insert(pair<char *, uv_long>(tmpkey, tmpuv));
...
void test_ab (long int coeff_a, long int coeff_b, long int h_height, long int l_height, multimap<char *, uv_long, cmp_str> &myMMap, int rank, char * logpath) {
    ...
    multimap<char *, uv_long, cmp_str>::iterator it;
    ...
    while (current_a <= h_height) {
        ...
        while (current_b <= h_height) {
            ...
            if ( it != myMMap.end()) {
                ...
                cout << format_solution (current_a, current_b, uv.u, uv.v);
